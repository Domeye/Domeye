...
<script>
import { getWorldJsonDataApi } from "@/api/getAPI";
        ...
        series: [
          {
            ...
            zoom: 1.45,
            center: [0.00, 29.71],  // 当前视角的中心点
            // 地图区域的多边形 图形样式
            itemStyle: {
              areaColor: "#333333", // 地图区域的颜色 如果设置了visualMap，areaColor属性将不起作用
              borderWidth: 0.5, // 描边线宽 为 0 时无描边
              borderColor: "rgb(19, 19, 19)", // 图形的描边颜色 支持的颜色格式同 color，不支持回调函数
